...
function renderTemmlError(value: string, error: unknown, options: Record<string, any>): string {
 ...
 */
export function temml(options?: Record<string, any>) {
