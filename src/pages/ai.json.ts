...
import { buildAiJson, getSite, loadConfig } from "@utils/ai-discovery";
...
export const GET: APIRoute = async (context) => {
    ...
    if (!isAiFileEnabled(aiConfig?.conformance, "ai.json")) {
    ...
    const body = JSON.stringify(buildAiJson(config, site), null, 2);
