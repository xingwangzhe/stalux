...
import { getSite, loadConfig, renderDeveloperAiTxt } from "@utils/ai-discovery";
...
export const GET: APIRoute = async (context) => {
    ...
    if (!isAiFileEnabled(aiConfig?.conformance, "developer-ai.txt")) {
    ...
    const text = renderDeveloperAiTxt(config, site);
